# Desafio 032: saber se um ano é bissexto ou não:
# esse primeiro if é só para pegar o ano atual de hoje:
...
# o código abaixo foi feito na primeira vez que fiz o curso
